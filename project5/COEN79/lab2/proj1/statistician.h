...
namespace coen79_lab2
{
    class statistician {
        public:
            ...
            void next(double r); // adds next number to the sequence
            ...
            double minimum() const;
            double maximum() const;
            friend statistician operator +(const statistician& s1,const statistician& s2); // allows sequence addition
            friend statistician operator *(double scale, const statistician& s); // allows sequence scaling
        private:
            double total; // Sum of all numbers in the sequence
            int size; // Amount of numbers in the sequence
            double min; // smallest number in the sequence
            double max; // largest number in the sequence
            double avg; // average of the numbers in the sequence

    };

bool operator ==(const statistician& s1,const statistician& s2); // allows sequence equality
